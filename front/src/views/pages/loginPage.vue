<template >
    ...
    <div class="form-floating">
      <input type="email" class="form-control" v-model="user.login" id="floatingInput" placeholder="name@example.com">
    ...
    <button class="w-100 btn btn-lg "  style="background-color: #F07D0A;" type="submit">Sign in</button>
  </form>
</main>
</body>
</template>
