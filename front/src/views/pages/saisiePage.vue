<template>
    <layout-template :pageTitre="com_tiltePage" :region="com_region" :commune="com_commune"
        ...
        <div class="container-fluid">
           ...
           <q1-page :commune="commune.code" :mois="mois.code"  :semaine="semaine" :type_releve="type_releve.code" v-if="semaine=='01' && commune.code > 0 && mois.code > 0 && type_releve.code > 0 && quest=='Quest_O1'"></q1-page>
...
export default defineComponent({
    ...
    setup() {
        ...
        return {
            ...toRefs(state), com_data1,
            com_point_ventes, service,
            com_selectedRow, com_region, com_commune, com_superviseur,
