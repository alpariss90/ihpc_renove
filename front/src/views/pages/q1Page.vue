                    ...
                    <tr v-for="v in datas" v-bind:key="v.code">
                        ...
                        <td>
                            <input type="number" class="form-control from-control-sm" v-model="v.quantite1"
                                placeholder="qte1" disabled="true" />
                        </td>
                        <td>
                        ...
                        <td>
                            <input type="number" class="form-control from-control-sm" v-model="v.quantite2"
                                placeholder="qte2" disabled="true" />
                        </td>
                        <td>
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const getData = async () => {
            try {
                const response = await service.getData1(props.commune, props.mois, props.semaine, props.enqueteur);
        ...
        const check = () => {
            ...
            state.selectedRow = state.datas.filter(e => {
                return e.date_passage != null || e.prix1 != null || e.prix2 != null || e.point_vente != '00' || e.observation != null
            })
